...
/**
 * Spring Security 6 configuration for the User Service.
 *
 * Stateless JWT-based security. No sessions, no CSRF tokens needed.
...
public class SecurityConfig {
    ...
    /**
     * BCrypt with strength 12 — strong enough for password hashing,
     * balances security with acceptable login latency (~300ms at strength 12).
     */
    @Bean
